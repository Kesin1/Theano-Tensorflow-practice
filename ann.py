...
class LogisticRegression(object):
    ...
    def fit(self, X, Y, lr=1e-2, reg=1-3, train_perc=0.9, eps=1e-9, batchsz=100, epochs=20, print_per=20, show_fig=False):
...
if __name__ == "__main__":
    ...
    model.fit(X[:-1000], Y[:-1000], epochs=100, show_fig=True)
